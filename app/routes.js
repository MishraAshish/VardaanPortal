...
module.exports = function(app) {
  ...
  app.post('/api/createuser', function(req, res) {
    ...
    console.log(req.body.Location._id);
    var today = new Date();
    ...
    var patient = new Patient({
      ...
      locationId: req.body.Location._id,// from location table like pratap vihar/ astha etc
      chiefComplaintsId: req.body.CheifComplaints, //Name of the disease -- should come from disease table
  ...
  // --api/editpatient
  app.post('/api/editpatients', function(req, res) {
    console.log(req.body);
    var Patient = require('./api/createPatients/createuserModel');
