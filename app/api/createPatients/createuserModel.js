...
var patientSchema = new Schema({
  ...
  gender:Number, // 1-Male, 2-Female, 3-Trans
  age:Number,
  mobile: Number,
  email: { type: String, unique: true },
  admin: Boolean,// will remain false
  centerId: Number,// from location table like pratap vihar/ astha etc
  locationId: Array,// from putting loacal loaction to refine search
  address: String,
  occupationId: Number,
  chiefComplaintsId: Array, //Name of the disease -- should come from disease table
  diagnosisId: Array, //Name of the diagnosis provided -- should come from diagnosis table
  treatmentId: Array,
  referenceId: Number, // Should come from reference table -- doctor, patient, advertisement, website, self
  doctorId: Number,
